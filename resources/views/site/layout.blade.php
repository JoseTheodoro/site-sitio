...
<head>
    ...
    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-28626102-2"></script>
    <script>
      window.dataLayer = window.dataLayer || [];
      function gtag(){dataLayer.push(arguments);}
      gtag('js', new Date());

      gtag('config', 'UA-28626102-2');
    </script>
	...
	<title>Sítio Jardim dos Vagalumes - Mogi das Cruzes - Restaurante e Turismo Rural</title>
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
          <ul class="navbar-nav mr-auto">
            ...
            <a class="nav-link" href={{route('fotos')}}>Fotos</a>
             ...
             <li class="nav-item">
             <a class="nav-link" href={{route('gastronomia')}}>Cardápios</a>
            </li>
            <li class="nav-item">
